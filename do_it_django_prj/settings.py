...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-kho_3x8l-hxpw*b6t=(#=_mp99ye=k%5)wbq6_f!zgup7aye1)')
...
MEDIA_ROOT = os.path.join(BASE_DIR, '_media') # 실제 파일은 _media에 저장s
